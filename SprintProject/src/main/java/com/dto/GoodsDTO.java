...
public class GoodsDTO {
	...
	public GoodsDTO(String gid, String sid, String gcategory, String gname, int gprice, String gsize, int gdiscount,
			String gimage1, String gimage2, String gimage3, String gdetail, String grdate, int ghit, int gsell,
			int gamount) {
		super();
		this.gid = gid;
		this.sid = sid;
	...
	public String toString() {
		return "GoodsDTO [gid=" + gid + ", sid=" + sid + ", gcategory=" + gcategory + ", gname=" + gname + ", gprice="
				...
				+ gimage2 + ", gimage3=" + gimage3 + ", gdetail=" + gdetail + ", grdate=" + grdate + ", ghit=" + ghit
				+ ", gsell=" + gsell + ", gamount=" + gamount + "]";
	}
