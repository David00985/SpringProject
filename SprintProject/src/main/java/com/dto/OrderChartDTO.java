...
//	----------------------------------결재수단
	...
	public OrderChartDTO(String mid, String ordate, String oname, String ophone1, String ophone2, String ophone3,
			String oaddress1, int opindex, String gid, int oprice, String gname, String gimage, String gcolor,
			String gsize, int gamount, int gprice, String code, int discount, String content, String company,
			String cardnumber, int opaymentcheck, int used) {
		super();
		this.mid = mid;
		this.ordate = ordate;
		this.oname = oname;
	...
	public String toString() {
		return "OrderChartDTO [mid=" + mid + ", ordate=" + ordate + ", oname=" + oname + ", ophone1=" + ophone1
				...
				+ ", gid=" + gid + ", oprice=" + oprice + ", gname=" + gname + ", gimage=" + gimage + ", gcolor="
				+ gcolor + ", gsize=" + gsize + ", gamount=" + gamount + ", gprice=" + gprice + ", code=" + code
				+ ", discount=" + discount + ", content=" + content + ", company=" + company + ", cardnumber="
				+ cardnumber + ", opaymentcheck=" + opaymentcheck + ", used=" + used + "]";
	}
